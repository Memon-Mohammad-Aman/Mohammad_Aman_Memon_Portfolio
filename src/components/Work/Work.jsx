...
const Work = () => {
  ...
  return (
    <section
      id="work"
      className="py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[20vw] font-sans relative bg-white dark:bg-gray-900 transition-colors"
    >
      {/* Section Title */}
            ...
            <div className="p-6">
              ...
              <div className="mb-4">
                {project.tags.map((tag, index) => (
                  <span
                    key={index}
                    className="inline-block bg-purple-100 dark:bg-[#251f38] text-xs font-semibold text-purple-600 dark:text-purple-400 rounded-full px-2 py-1 mr-2 mb-2"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <div className="lg:p-8 p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {selectedProject.tags.map((tag, index) => (
                    <span
                      key={index}
                      className="bg-purple-100 dark:bg-[#251f38] text-xs font-semibold text-purple-600 dark:text-purple-400 rounded-full px-2 py-1"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="w-1/2 bg-gray-100 dark:bg-gray-800 hover:bg-purple-600 dark:hover:bg-purple-700 text-gray-800 dark:text-gray-300 px-4 py-2 rounded-xl text-center font-semibold transition"
                  >
                    View Code
                  </a>
                </div>
